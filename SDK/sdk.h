...
public:
	...
	virtual void copyDepthStencilViewTarget(const std::string & name, const DepthStencilView & ds) = 0;
	...
	virtual bool unpackDepthTarget(const std::string& name, int W, int H, int C, unsigned char* depth, unsigned char* stencil) = 0;
...
public:
	...
	virtual void copyDepthStencilViewTarget(const std::string & name, const DepthStencilView & ds) final 
	{ 
		main_->copyDepthStencilViewTarget(name, ds);
	...
	virtual bool unpackDepthTarget(const std::string& name, int W, int H, int C, unsigned char* depth, unsigned char* stencil) { return main_->unpackDepthTarget(name, W, H, C, depth, stencil); }
